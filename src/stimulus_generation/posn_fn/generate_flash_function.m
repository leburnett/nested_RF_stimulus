...
% ______________________________________________________________________
    ...
    param.dur = (numel(func)*2)/1000; % func consists of 1 element every 2ms. n_elements*2 = time in ms. Divide by 100 to get time in seconds. %(n_flashes*flash_dur + (n_flashes)*interval_dur)*2; %  x2 for ON / OFF
