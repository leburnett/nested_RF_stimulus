function [max_v, min_v] = plot_timeseries_polar_bars_pharma(data, median_v, params, save_fig, fig_save_folder)
    ...
    max_v_polar1 = vertcat(max_v(:, 1), max_v(1, 1)); % 28 bars
    max_v_polar2 = vertcat(max_v(:, 2), max_v(1, 2)); % 56 bars
    max_v_polar3 = vertcat(max_v(:, 3), max_v(1, 3)); % 168 bars
    max_v_polar4 = vertcat(max_v(:, 4), max_v(1, 4)); % 250 bars
    max_v_polar5 = vertcat(max_v(:, 5), max_v(1, 5)); % 500 bars
    ...
    if save_fig
        ...
        f = gcf; 
        fname = fullfile(fig_folder, strcat(params.strain, '_', params.on_off, '_', params.date, '_', params.time, '_', params.application, '_', params.drug, '_bar_polar.pdf'));
        exportgraphics(f ...
                , fname ...
                , 'ContentType', 'vector' ...
